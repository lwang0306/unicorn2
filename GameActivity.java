	...
	protected Dialog onCreateDialog(int id) {
		if (id == 0) {
			...
			if (bestTime == 10000000) {
				...
				builder.setMessage("Great job! You finished in " + displayTime
						+ " seconds");
			} else if (displayTime <= bestTime) {
				bestTime = displayTime;
				builder.setMessage("You finished in " + displayTime
						+ " seconds! That's the fastest so far!");
			} else
				builder.setMessage("Great job! You finished in " + displayTime
						+ " seconds; the best so far is " + bestTime);
